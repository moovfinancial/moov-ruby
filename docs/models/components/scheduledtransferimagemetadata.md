...
| ------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------- |
| `image_id`                                                    | *::String*                                                    | :heavy_check_mark:                                            | Unique identifier for a image resource.                       |                                                               |
...
| `public_id`                                                   | *::String*                                                    | :heavy_check_mark:                                            | A unique identifier for an image, used in public image links. |                                                               |