...
Gem::Specification.new do |s|
  s.name        = 'moov_ruby'
  s.version     = '26.4.0-dev.11'
  s.platform    = Gem::Platform::RUBY
  s.licenses    = ['Apache-2.0']
  s.summary     = ''
  s.homepage    = 'https://github.com/moovfinancial/moov-ruby.git'
  s.description = 'Ruby Client SDK Generated by Speakeasy'
  s.authors     = ['Speakeasy']
  s.metadata    = {
    'homepage_uri' => 'https://github.com/moovfinancial/moov-ruby.git',
    'documentation_uri' => 'https://github.com/moovfinancial/moov-ruby.git',
