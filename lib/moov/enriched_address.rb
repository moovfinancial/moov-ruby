...
module Moov
  ...
  class EnrichedAddress
    ...
    def get(request:, timeout_ms: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::GetEnrichmentAddressRequest, request, nil, @sdk_configuration.globals)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::EnrichedAddressResponse)
          response = Models::Operations::GetEnrichmentAddressResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            headers: http_response.headers,
            enriched_address_response: T.unsafe(obj)
          )
