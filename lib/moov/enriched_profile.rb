...
module Moov
  ...
  class EnrichedProfile
    ...
    sig { params(email: ::String, x_moov_version: T.nilable(::String), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetEnrichmentProfileResponse) }
    def get(email:, x_moov_version: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::EnrichedBusinessResponse)
          response = Models::Operations::GetEnrichmentProfileResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            headers: http_response.headers,
            enriched_business_response: T.unsafe(obj)
          )
