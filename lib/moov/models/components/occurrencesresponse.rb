  ...
  module Models
    module Components
      ...
      class OccurrencesResponse
        ...
        field :run_on, ::DateTime, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('runOn'), required: true, 'decoder': ::Moov::Utils.datetime_from_iso_format(false) } }
        ...
        field :ran_on, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::Moov::Utils.field_name('ranOn'), 'decoder': ::Moov::Utils.datetime_from_iso_format(true) } }
        ...
        field :status, Crystalline::Nilable.new(Models::Components::OccurrenceStatus), { 'format_json': { 'letter_case': ::Moov::Utils.field_name('status'), 'decoder': ::Moov::Utils.open_enum_from_string(Models::Components::OccurrenceStatus, true) } }
