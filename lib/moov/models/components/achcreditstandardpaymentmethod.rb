  ...
  module Models
    module Components
      ...
      class AchCreditStandardPaymentMethod
        ...
        field :payment_method_type, Models::Components::AchCreditStandardPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': Utils.enum_from_string(Models::Components::AchCreditStandardPaymentMethodPaymentMethodType, false) } }
