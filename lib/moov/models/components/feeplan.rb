  ...
  module Models
    module Components
      ...
      class FeePlan
        ...
        field :created_at, ::DateTime, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('createdAt'), required: true, 'decoder': ::Moov::Utils.datetime_from_iso_format(false) } }
        # A description of the fee plan.
        field :description, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::Moov::Utils.field_name('description') } }

        sig { params(plan_id: ::String, name: ::String, card_acquiring_model: Models::Components::CardAcquiringModel, billable_fees: T::Array[Models::Components::BillableFee], minimum_commitment: Models::Components::MinimumCommitment, monthly_platform_fee: Models::Components::MonthlyPlatformFee, created_at: ::DateTime, description: T.nilable(::String)).void }
        def initialize(plan_id:, name:, card_acquiring_model:, billable_fees:, minimum_commitment:, monthly_platform_fee:, created_at:, description: nil)
          @plan_id = plan_id
          @name = name
