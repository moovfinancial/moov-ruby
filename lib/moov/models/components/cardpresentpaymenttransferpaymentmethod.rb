  ...
  module Models
    module Components
      ...
      class CardPresentPaymentTransferPaymentMethod
        ...
        field :payment_method_type, Models::Components::CardPresentPaymentTransferPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': ::Moov::Utils.enum_from_string(Models::Components::CardPresentPaymentTransferPaymentMethodPaymentMethodType, false) } }
        ...
        sig { params(payment_method_id: ::String, payment_method_type: Models::Components::CardPresentPaymentTransferPaymentMethodPaymentMethodType, terminal_card: T.nilable(Models::Components::TransferTerminalCard)).void }
