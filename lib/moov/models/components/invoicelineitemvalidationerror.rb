  ...
  module Models
    module Components
      ...
      class InvoiceLineItemValidationError
        ...
        field :options, Crystalline::Nilable.new(Crystalline::Hash.new(Symbol, Models::Components::InvoiceLineItemOptionValidationError)), { 'format_json': { 'letter_case': ::Moov::Utils.field_name('options') } }
