  ...
  module Models
    module Components
      ...
      class PushToGooglePayPaymentMethod
        ...
        field :payment_method_type, Models::Components::PushToGooglePayPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': ::Moov::Utils.enum_from_string(Models::Components::PushToGooglePayPaymentMethodPaymentMethodType, false) } }
        ...
        sig { params(payment_method_id: ::String, payment_method_type: Models::Components::PushToGooglePayPaymentMethodPaymentMethodType, google_pay: Models::Components::GooglePayResponse).void }
