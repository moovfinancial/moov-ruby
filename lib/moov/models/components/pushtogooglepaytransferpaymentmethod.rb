  ...
  module Models
    module Components
      ...
      class PushToGooglePayTransferPaymentMethod
        ...
        field :payment_method_type, Models::Components::PushToGooglePayTransferPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': ::Moov::Utils.enum_from_string(Models::Components::PushToGooglePayTransferPaymentMethodPaymentMethodType, false) } }
        ...
        sig { params(payment_method_id: ::String, payment_method_type: Models::Components::PushToGooglePayTransferPaymentMethodPaymentMethodType, google_pay: Models::Components::GooglePayResponse).void }
