...
class Moov::Models::Components::ScheduleListResponse
  ...
  def destination_account_id=(str_); end
  def mode(); end
  def mode=(str_); end
  ...
  def occurrences(); end
  def occurrences=(str_); end
  def recur(); end
  def recur=(str_); end
  def disabled_on(); end
  def disabled_on=(str_); end
  def source_account(); end
  def source_account=(str_); end
  def destination_account(); end
  def destination_account=(str_); end
  def partner_account(); end
  def partner_account=(str_); end
end