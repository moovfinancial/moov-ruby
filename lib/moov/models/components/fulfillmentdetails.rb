  ...
  module Models
    module Components
      ...
      class FulfillmentDetails
        ...
        field :return_policy, Models::Components::ReturnPolicyType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('returnPolicy'), required: true, 'decoder': ::Moov::Utils.open_enum_from_string(Models::Components::ReturnPolicyType, false) } }
