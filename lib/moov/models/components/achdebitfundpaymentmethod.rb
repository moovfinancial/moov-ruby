  ...
  module Models
    module Components
      ...
      class AchDebitFundPaymentMethod
        ...
        sig { params(payment_method_id: ::String, payment_method_type: Models::Components::AchDebitFundPaymentMethodPaymentMethodType, bank_account: Models::Components::PaymentMethodsBankAccount).void }
