  ...
  module Models
    module Components
      ...
      class AchCreditStandardTransferPaymentMethod
        ...
        field :payment_method_type, Models::Components::AchCreditStandardTransferPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': ::Moov::Utils.enum_from_string(Models::Components::AchCreditStandardTransferPaymentMethodPaymentMethodType, false) } }
