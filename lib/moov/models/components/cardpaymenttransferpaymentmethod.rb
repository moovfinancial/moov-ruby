  ...
  module Models
    module Components
      ...
      class CardPaymentTransferPaymentMethod
        ...
        sig { params(payment_method_id: ::String, payment_method_type: Models::Components::CardPaymentTransferPaymentMethodPaymentMethodType, card: Models::Components::TransferPaymentMethodsCard).void }
