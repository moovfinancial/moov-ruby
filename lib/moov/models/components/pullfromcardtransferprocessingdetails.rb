  ...
  module Models
    module Components
      ...
      class PullFromCardTransferProcessingDetails
        ...
        field :status, Models::Components::PullFromCardTransactionStatus, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('status'), required: true, 'decoder': ::Moov::Utils.open_enum_from_string(Models::Components::PullFromCardTransactionStatus, false) } }
        ...
        sig { params(status: Models::Components::PullFromCardTransactionStatus, authorization_code: T.nilable(::String), network_transaction_id: T.nilable(::String), network_response_code: T.nilable(::String), failure_code: T.nilable(Models::Components::CardTransactionFailureCode)).void }
