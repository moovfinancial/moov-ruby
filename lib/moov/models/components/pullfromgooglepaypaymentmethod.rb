  ...
  module Models
    module Components
      ...
      class PullFromGooglePayPaymentMethod
        ...
        field :payment_method_type, Models::Components::PullFromGooglePayPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': ::Moov::Utils.enum_from_string(Models::Components::PullFromGooglePayPaymentMethodPaymentMethodType, false) } }
        ...
        sig { params(payment_method_id: ::String, payment_method_type: Models::Components::PullFromGooglePayPaymentMethodPaymentMethodType, google_pay: Models::Components::GooglePayResponse).void }
