  ...
  module Models
    module Components
      ...
      class CustomerSupport
        ...
        sig { params(phone: T.nilable(Models::Components::PhoneNumber), email: T.nilable(::String), address: T.nilable(Models::Components::Address), website: T.nilable(::String)).void }
