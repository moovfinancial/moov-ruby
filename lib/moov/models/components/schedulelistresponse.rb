  ...
  module Models
    module Components
      ...
      class ScheduleListResponse
        ...
        field :destination_account, Crystalline::Nilable.new(Models::Components::PartialScheduleAccount), { 'format_json': { 'letter_case': ::Moov::Utils.field_name('destinationAccount') } }
        ...
        def ==(other)
          ...
          return false unless @source_account == other.source_account
          return false unless @destination_account == other.destination_account
          return false unless @partner_account == other.partner_account
          true
        end
      end
    end
