  ...
  module Models
    module Components
      ...
      class AchCreditSameDayTransferPaymentMethod
        ...
        field :payment_method_type, Models::Components::AchCreditSameDayTransferPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': ::Moov::Utils.enum_from_string(Models::Components::AchCreditSameDayTransferPaymentMethodPaymentMethodType, false) } }
