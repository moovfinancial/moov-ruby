  ...
  module Models
    module Components
      ...
      class EstimatedActivity
        ...
        field :monthly_volume_range, Crystalline::Nilable.new(Models::Components::MonthlyVolumeRange), { 'format_json': { 'letter_case': ::Moov::Utils.field_name('monthlyVolumeRange'), 'decoder': ::Moov::Utils.open_enum_from_string(Models::Components::MonthlyVolumeRange, true) } }
