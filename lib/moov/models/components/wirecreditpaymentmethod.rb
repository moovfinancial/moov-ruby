  ...
  module Models
    module Components
      ...
      class WireCreditPaymentMethod
        ...
        field :payment_method_type, Models::Components::WireCreditPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': ::Moov::Utils.enum_from_string(Models::Components::WireCreditPaymentMethodPaymentMethodType, false) } }
        ...
        sig { params(payment_method_id: ::String, payment_method_type: Models::Components::WireCreditPaymentMethodPaymentMethodType, bank_account: Models::Components::PaymentMethodsBankAccount).void }
