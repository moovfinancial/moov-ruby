  ...
  module Models
    module Components
      ...
      class WireCreditTransferPaymentMethod
        ...
        field :payment_method_type, Models::Components::WireCreditTransferPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': ::Moov::Utils.enum_from_string(Models::Components::WireCreditTransferPaymentMethodPaymentMethodType, false) } }
        ...
        sig { params(payment_method_id: ::String, payment_method_type: Models::Components::WireCreditTransferPaymentMethodPaymentMethodType, bank_account: Models::Components::TransferPaymentMethodsBankAccount).void }
