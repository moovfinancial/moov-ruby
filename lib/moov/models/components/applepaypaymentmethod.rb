  ...
  module Models
    module Components
      ...
      class ApplePayPaymentMethod
        ...
        field :payment_method_type, Models::Components::ApplePayPaymentMethodPaymentMethodType, { 'format_json': { 'letter_case': ::Moov::Utils.field_name('paymentMethodType'), required: true, 'decoder': Utils.enum_from_string(Models::Components::ApplePayPaymentMethodPaymentMethodType, false) } }
