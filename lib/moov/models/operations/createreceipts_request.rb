  ...
  module Models
    module Operations
      ...
      class CreateReceiptsRequest
        ...
        field :request_body, Crystalline::Array.new(Models::Components::ReceiptRequest), { 'request': { 'media_type': 'application/json' } }
        ...
        def initialize(request_body:, x_moov_version: 'v2024.01.00')
