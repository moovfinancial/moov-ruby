  ...
  module Models
    module Operations
      ...
      class ListDisputesRequest
        ...
        def initialize(account_id:, skip: nil, count: nil, start_date_time: nil, end_date_time: nil, respond_start_date_time: nil, respond_end_date_time: nil, status: nil, merchant_account_id: nil, cardholder_account_id: nil, dispute_i_ds: nil, transfer_i_ds: nil, order_by: nil)
