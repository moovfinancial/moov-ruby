  ...
  module Models
    module Operations
      ...
      class RetrieveFeesRequest
        ...
        sig { params(account_id: ::String, transfer_id: T.nilable(::String), dispute_id: T.nilable(::String), start_date_time: T.nilable(::String), end_date_time: T.nilable(::String), skip: T.nilable(::Integer), count: T.nilable(::Integer), x_moov_version: T.nilable(::String)).void }
        def initialize(account_id:, transfer_id: nil, dispute_id: nil, start_date_time: nil, end_date_time: nil, skip: nil, count: nil, x_moov_version: 'v2024.01.00')
