  ...
  module Models
    module Operations
      ...
      class UpdateIssuedCardRequest
        ...
        sig { params(account_id: ::String, issued_card_id: ::String, update_issued_card: Models::Components::UpdateIssuedCard).void }
        def initialize(account_id:, issued_card_id:, update_issued_card:)
