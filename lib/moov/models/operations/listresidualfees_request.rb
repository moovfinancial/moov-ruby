  ...
  module Models
    module Operations
      ...
      class ListResidualFeesRequest
        ...
        sig { params(account_id: ::String, residual_id: ::String, x_moov_version: T.nilable(::String), skip: T.nilable(::Integer), count: T.nilable(::Integer), start_date_time: T.nilable(::String), end_date_time: T.nilable(::String)).void }
        def initialize(account_id:, residual_id:, x_moov_version: nil, skip: nil, count: nil, start_date_time: nil, end_date_time: nil)
