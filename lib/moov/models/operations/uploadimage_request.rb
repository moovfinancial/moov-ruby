  ...
  module Models
    module Operations
      ...
      class UploadImageRequest
        ...
        sig { params(account_id: ::String, image_upload_request_multi_part: Models::Components::ImageUploadRequestMultiPart).void }
        def initialize(account_id:, image_upload_request_multi_part:)
