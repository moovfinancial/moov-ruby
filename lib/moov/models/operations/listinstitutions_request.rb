  ...
  module Models
    module Operations
      ...
      class ListInstitutionsRequest
        ...
        sig { params(name: T.nilable(::String), routing_number: T.nilable(::String), state: T.nilable(::String), limit: T.nilable(::Integer)).void }
        def initialize(name: nil, routing_number: nil, state: nil, limit: nil)
          @name = name
