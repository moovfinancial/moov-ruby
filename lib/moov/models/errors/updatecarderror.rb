  ...
  module Models
    module Errors
      ...
      class UpdateCardError < StandardError
        ...
        sig { params(e2ee: T.nilable(Models::Components::End2EndEncryptionError), billing_address: T.nilable(::String), expiration: T.nilable(::String), card_cvv: T.nilable(::String), card_on_file: T.nilable(::String), merchant_account_id: T.nilable(::String), verify_name: T.nilable(::String), holder_name: T.nilable(::String), raw_response: T.nilable(::Faraday::Response)).void }
        def initialize(e2ee: nil, billing_address: nil, expiration: nil, card_cvv: nil, card_on_file: nil, merchant_account_id: nil, verify_name: nil, holder_name: nil, raw_response: nil)
          @e2ee = e2ee
