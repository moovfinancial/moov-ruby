  ...
  class Capabilities
    ...
    def list(account_id:, x_moov_version: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Components::Capability))
          response = Models::Operations::ListCapabilitiesResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            headers: http_response.headers,
            capabilities: T.unsafe(obj)
          )
    ...
    def request(add_capabilities:, account_id:, x_moov_version: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Components::Capability))
          response = Models::Operations::RequestCapabilitiesResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            headers: http_response.headers,
        ...
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Errors::AddCapabilitiesError)
          obj.raw_response = http_response
          raise obj
        else
          raise ::Moov::Models::Errors::APIError.new(status_code: http_response.status, body: http_response.env.response_body, raw_response: http_response), 'Unknown content type received'
    ...
    def get(account_id:, capability_id:, x_moov_version: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::Capability)
          response = Models::Operations::GetCapabilityResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            headers: http_response.headers,
            capability: T.unsafe(obj)
          )
    ...
    def disable(account_id:, capability_id:, x_moov_version: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['204'])
        ...
        return Models::Operations::DisableCapabilityResponse.new(
          status_code: http_response.status,
          content_type: content_type,
          raw_response: http_response,
          headers: {}
